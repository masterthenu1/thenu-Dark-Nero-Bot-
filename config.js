...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("94767096711,")
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? 'mr-thenu' : process.env.OWNER_NAME,
  ...
  caption :process.env.CAPTION || "  \t🎋⃟🥷 *ᴄʀᴇᴀᴛᴇᴅ ʙʏ mr thenuᴛᴇᴀᴍ*",
